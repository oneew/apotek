...
export default function PelayananSwamedikasi() {
  const columns = [
    ...
    { key: 'kode', label: 'Kode Swamedikasi' },
  ...
  const dummyData = [
    { id: 1, no: '1', tanggal: '18/04/2026\n14:07', kode: 'SMB260418-1-1-2', pasien: 'andi\nEMR000001', apoteker: '', keluhan: '' }
  ];
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-6 pb-12">
      <SectionHeader 
        title="Swamedikasi" 
        rightContent={
          <Link to="/pelayanan/swamedikasi/baru" className="flex items-center gap-2 px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white rounded-lg text-sm font-bold shadow-sm shadow-teal-600/20 transition-all active:scale-95">
            <FiPlus size={18} /> Swamedikasi
          </Link>
        }
      />
      ...
      <div className="bg-white dark:bg-[#1e1e24] border border-gray-100 dark:border-[#2a2a30] rounded-2xl shadow-sm overflow-hidden mt-6">
        ...
        <div className="p-5">
           ...
           <div className="flex flex-col sm:flex-row gap-8">
             <p className="flex-1 flex justify-between text-sm text-gray-600 dark:text-gray-400 font-medium"><span>Jumlah Pemeriksaan</span> <span>: 1</span></p>
