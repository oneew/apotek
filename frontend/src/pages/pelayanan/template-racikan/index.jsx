...
export default function PelayananTemplateRacikan() {
  ...
  const dummyData = [
    { id: 1, no: '1', nama: 'Template Flu & Batuk', jumlah: '3', pembuat: 'Administrator' }
  ];
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-6 pb-12">
      <SectionHeader 
        ...
        rightContent={
          <Link to="/pelayanan/template-racikan/baru" className="flex items-center gap-2 px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white rounded-lg text-sm font-bold shadow-sm shadow-teal-600/20 transition-all active:scale-95">
            <FiPlus size={18} /> Tambah Template
          </Link>
        }
      />
