...
export default function KontakSupplier() {
  const columns = [
    ...
    { key: 'badan', label: 'Badan Usaha' },
    { key: 'telepon', label: 'Telepon' },
    { key: 'kredit', label: 'Batas Kredit', render: (val) => <span className="font-medium text-emerald-600 dark:text-emerald-400">{val || 'Rp 0'}</span> },
