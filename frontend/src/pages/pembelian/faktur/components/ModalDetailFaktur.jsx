        ...
        <>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-6 pt-4 border-t border-gray-100 dark:border-gray-800">
              ...
              <div className="flex gap-3 w-full sm:w-auto">
                  <button 
                      ...
                      className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-6 py-2.5 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 hover:border-gray-400 text-gray-700 dark:text-gray-300 rounded-lg text-[11px] font-bold uppercase transition-all shadow-sm active:scale-95 group">
          ...
          <PrintWrapper ref={printRef}>
              <LetterA4 
                  data={{
                      ...data,
                      invoice_no: data.no_faktur,
                      tanggal: data.tanggal_pembelian,
                      items: data.items?.map(i => ({
                          ...i,
                          nama_produk: i.nama_produk,
                          qty: i.jumlah_beli,
                          harga_satuan: i.harga_beli_per_satuan
                      }))
                  }} 
                  type="FAKTUR_PEMBELIAN"
              />
          </PrintWrapper>
        </>
      ) : (
