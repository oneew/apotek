...
export default function JenisPelayanan() {
  ...
  const columns = [
    { label: 'Nama Pelayanan', key: 'nama_pelayanan', render: (val) => (
      <div className="flex flex-col">
        <span className="font-semibold text-gray-900 dark:text-gray-100 uppercase text-xs">{val}</span>
        <span className="text-[10px] text-gray-500 font-medium tracking-tight">TIPE LAYANAN KLINIS</span>
      </div>
    )},
  ...
  return (
    <div className="max-w-[1440px] mx-auto space-y-6 pb-20">
      <SectionHeader 
        ...
        subtitle="Kelola tipe layanan klinis termasuk praktek umum, peracikan obat, dan laboratorium."
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4 shadow-sm">
        <DataTable 
          ...
          searchPlaceholder="Filter layanan berdasarkan nama..."
          primaryAction={{ label: "Tambah Layanan", onClick: () => handleOpenModal() }}
        />
      </div>
      ...
      <ModalDialog
        ...
        title={isEditing ? 'Ubah Identitas Layanan' : 'Registrasi Layanan'}
        subtitle="Menetapkan batasan untuk operasi klinis."
        icon={<FiActivity />}
        maxWidth="max-w-xl"
      >
        <div className="p-8 space-y-8">
          <div className="space-y-6">
            <div className="flex items-center gap-2 border-b border-gray-100 dark:border-gray-800 pb-3">
              ...
              <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Atribut Layanan</h3>
            </div>
            
            <div className="space-y-4">
              <div className="space-y-1.5 focus-within:text-primary-600 transition-colors">
                <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Penamaan Layanan <span className="text-red-500 font-bold">*</span></label>
                <input 
                  type="text" 
          ...
          <div className="flex justify-end gap-3 pt-6 border-t border-gray-100 dark:border-gray-800">
            ...
            >
              {isSubmitting ? 'Sinkronisasi...' : 'Simpan Data Layanan'}
            </button>
          </div>
        </div>
      </ModalDialog>
